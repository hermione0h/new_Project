...
it = 0
min_loss = np.inf
bst_model_fpath = '/data/liyuy/PROJECTS/DEREVERB3/LSTM/exp5/model/bst_model_wlen_'+'%d'%wlen+'_nfft_'+'%d'%nfft+'_overlap_'+'%d'%overlap+'time_lambda5.pth'
model.train(True)
